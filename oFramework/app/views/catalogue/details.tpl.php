             ...
             <div class="col-lg-6 col-sm-12">
                 <div class="mb-3">
                     <h3 class="mb-1 fs-2 fw-bold">
                         Crème de jour
                         <span class="text-muted fs-5 fw-lighter">peaux normales & mixtes</span>
                     </h3>
                     <div class="text-muted">50 ml</div>
                 </div>
                 <div class="mt-5">
                     <p>
                         Cette crème de jour certifiée bio contient de l'huile de macadamia bio et d'amande douce
                         bio, elle est idéale pour les peaux normales à mixtes. Avec de l'extrait de lys bio et
                         un
                         parfum 100% naturel, son odeur est subtile et fraîche.
                         Crème fabriquée en France
                     </p>
                 </div>
