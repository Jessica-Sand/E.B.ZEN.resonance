<div class="container">
    ...
    <div class="services py-5">
        <div class="container">
            <div class="row text-light" id="row-form">
                    <h2 class="text-light pb-4">Une question, besoin de plus d'information ?</h2>
                        ...
                        <div class="container-fluid">
                            <form action="<?= $router->generate('main-send') ?>" method="POST" id="contact-form">
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="text" class="form-control" id="nameForm" name="firstname"
                                        placeholder="Votre prénom">
                                </div>
                                <div class="mb-4">
                                    <label for="lastname" class="form-label fw-bold">Nom</label>
                                    <input type="text" class="form-control" id="nameForm" name="lastname"
